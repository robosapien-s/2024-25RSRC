...
public class rightSideAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder trajectory1 = drive.actionBuilder(initPose)
                ...
                .strafeToConstantHeading(new Vector2d(4.5, -40.5))
                .waitSeconds(.1)
...
//                .stopAndAdd(robotAuto.setClawHorizontalAnglePosition(RoboSapiensTeleOp.Params.CLAW_HORIZONTAL_ANGLE_LEFT))
                ...
                .waitSeconds(.25)
                .stopAndAdd(robotAuto.setState(IRobot.State.WALLPICKUP))
                .strafeToConstantHeading(new Vector2d(31.5,-62.5))
                .waitSeconds(.1)
                .stopAndAdd(robotAuto.setState(IRobot.State.SPECIMEN_HANG))
                .waitSeconds(.25)
                .strafeToConstantHeading(new Vector2d(9.4,-40))//2nd drop
                .waitSeconds(.25)
                .stopAndAdd(robotAuto.setState(IRobot.State.WALLPICKUP))
                .strafeToConstantHeading(new Vector2d(31.5,-62.5))
                .waitSeconds(.1)
                .stopAndAdd(robotAuto.setState(IRobot.State.SPECIMEN_HANG))
                .waitSeconds(.25)
                .strafeToConstantHeading(new Vector2d(11.2,-40))//3rd drop
                .waitSeconds(.25)
                .stopAndAdd(robotAuto.setState(IRobot.State.WALLPICKUP))
                .strafeToConstantHeading(new Vector2d(31.5,-62.5))
                .waitSeconds(.15)
                .stopAndAdd(robotAuto.setState(IRobot.State.SPECIMEN_HANG))
                .waitSeconds(.25)
                .strafeToConstantHeading(new Vector2d(13.5,-40))//4th drop
                .waitSeconds(.25)
                .stopAndAdd(robotAuto.setState(IRobot.State.WALLPICKUP))
