...
public class rightSideAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d initPose = new Pose2d(8,-64,Math.toRadians(90));
...
//                .lineToY(-44)
                ...
                .strafeToLinearHeading(new Vector2d(33,-43), Math.toRadians(30))
//                .waitSeconds(.2)
                ...
                .waitSeconds(.2)
                .stopAndAdd(robotAuto.setIntakeRotationServo(RoboSapiensTeleOp.Params.INTAKE_ROT_SERVO_DEFAULT-.16))
                .strafeToLinearHeading(new Vector2d(42.3,-43), Math.toRadians(30))
//                .waitSeconds(.2)
