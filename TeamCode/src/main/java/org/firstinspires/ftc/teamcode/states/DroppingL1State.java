...
public class DroppingL1State extends BaseState {
    ...
    public void initialize(Robot robot, IRobot prevState) {
        ...
        transferSeries.add(createClawSlideTask(robot, RoboSapiensTeleOp.Params.CLAW_SLIDER_BACK, 1, "CLAW_SLIDER_BACK", false));
        transferSeries.add(createClawAngleTask(robot, RoboSapiensTeleOp.Params.CLAW_ANGLE_BACK, 1, "CLAW_ANGLE_BACK", false));
