...
public class IntakingStateClaw extends BaseState {
    ...
    public void execute(Robot robot, Telemetry telemetry) {
        ...
        if(joystick.gamepad1GetX()) {
            ...
            transferSeries.add(createClawAngleTask(robot, RoboSapiensTeleOp.Params.CLAW_ANGLE_TRANSFER, 500, "IntakeClawOpen", false));
            transferSeries.add(createVerticalSlideTask(robot, RoboSapiensTeleOp.Params.VERTICAL_SLIDE_TRANSFER_POSITION, 1000, "IntakeClawClose", false));


            transferSeries.add(createIntakeRotationTask(robot, RoboSapiensTeleOp.Params.INTAKE_ROT_SERVO_DEFAULT, 1000, "IntakeClawClose", false));

            transferSeries.add(createIntakeKnuckleTask(robot, RoboSapiensTeleOp.Params.INTAKE_KNUCKLE_TRANSFER, 400, "IntakeClawClose", false));
            transferSeries.add(createIntakeClawTask(robot, RoboSapiensTeleOp.Params.INTAKE_CLAW_LOOSE, 300, "IntakeClawLoose", false));
            transferSeries.add(createIntakeClawAngleTask(robot, RoboSapiensTeleOp.Params.INTAKE_ANGLE_TRANSFER, 1000, "IntakeClawClose", false));
