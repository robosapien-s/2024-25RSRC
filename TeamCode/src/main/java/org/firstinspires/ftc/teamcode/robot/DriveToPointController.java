...
public class DriveToPointController {
    ...
    public static double xKp = .25;
    public static double xKd = .3; //PID values
...
//    public static double angleKi = 0;
    ...
    public static double angleKp = 2;
    public static double angleKd = 0; //PID values
    public static double angleKi = 0;
//
...
//    final SquidController angleSquid;
    ...
    public DriveToPointController() {
        ...
        yPid = new BasicPID(new PIDCoefficients(xKp,xKi,xKd));
