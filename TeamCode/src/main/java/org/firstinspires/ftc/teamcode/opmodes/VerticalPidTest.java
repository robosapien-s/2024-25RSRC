...
public class VerticalPidTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        slideController = new VerticalSlideController(hardwareMap, "verticalSlide1", "verticalSlide2", "clawSliderEncoder", true, RoboSapiensTeleOp.Params.VERTICAL_SLIDE_MAX_POSITION, 0, false);
        ...
        while (opModeIsActive()) {
            ...
            if(joystick.gamepad1GetRightBumperRaw()) {
                slideController.increaseTargetPosition((int) (joystick.gamepad1GetRightTrigger()*-100));
            } else {
                slideController.increaseTargetPosition((int) (joystick.gamepad1GetRightTrigger()*100));
            }
