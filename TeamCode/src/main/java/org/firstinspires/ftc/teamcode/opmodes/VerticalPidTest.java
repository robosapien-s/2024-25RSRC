...
public class VerticalPidTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        slideController = new VerticalSlideController(hardwareMap, "verticalSlide1", "verticalSlide2", true, RoboSapiensTeleOp.Params.VERTICAL_SLIDE_MAX_POSITION, 0, false);
