...
public class FConstants {
    static {
        ...
        FollowerConstants.headingPIDFCoefficients.setCoefficients(1.0,0,0.18,0);
        FollowerConstants.useSecondaryHeadingPID = false;
        FollowerConstants.secondaryHeadingPIDFCoefficients.setCoefficients(2,0,0.1,0); // Not being used, @see useSecondaryHeadingPID

        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.017,0,0.0001,0.6,0);
        FollowerConstants.useSecondaryDrivePID = false;
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.017,0,0.0001,0.6,0); // Not being used, @see useSecondaryDrivePID
